#!/usr/bin/env python3
"""
Advanced pandas/matplotlib workflow.
...
plt.tight_layout()
plt.savefig(OUTPUTS / "maximum_strategic_regret.png", dpi=150)
plt.close()
...
plt.title("Comparing Forecasting, Foresight, and Futures Studies")
plt.tight_layout()
