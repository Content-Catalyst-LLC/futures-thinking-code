...
python python/health_futures_advanced.py
```
...
Every output should be traceable to health system profiles, scenarios, strategy options, risk indicators, governance records, pathway parameters, and code.
