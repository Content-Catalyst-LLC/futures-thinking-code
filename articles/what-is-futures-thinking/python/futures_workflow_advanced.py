...
summary = summary.merge(
    regret_df.groupby("strategy")["regret"].agg(mean_regret="mean", max_regret="max").reset_index(),
    on="strategy"
...
practice_long.pivot(index="dimension", columns="practice", values="value").plot(kind="barh", figsize=(11, 7))
